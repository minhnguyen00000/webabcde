...
$manhanvien=2;
$query_dh->bindParam(':tennguoinhan',$tenkhachhang);
$query_dh->bindParam(':diachinguoinhan',$diachi);
$query_dh->bindParam(':sodienthoainguoinhan',$sodienthoai);
$query_dh->bindParam(':emailnguoinhan',$email);
...
$mail->Password = 'hpzbukyofvtgkcwp';                           // SMTP password
...
<div class="content_top">
  <div class="heading">
    <h3>Thông tin khách hàng <a href="index.php?ac=usersdondathang" class="btn btn-danger">Thông Tin Khác</a></h3>
  </div>
  <div class="see">
...
<form action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="tenkhachhang" readonly placeholder="Nhập Họ và Tên" name="tenkhachhang" value="<?php echo $dong['tenkhachhang'] ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id=" diachi" readonly placeholder="Nhập Địa chỉ" name="diachi" value="<?php echo $dong['diachi'] ?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="sodienthoai" class="col-sm-2 col-form-label">SĐT</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="sodienthoai" readonly placeholder="Nhập SĐT" name="sodienthoai" value="<?php echo $dong['sodienthoai'] ?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="email" class="col-sm-2 col-form-label">Email</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="email" readonly placeholder="Nhập Email" name="email" value="<?php echo $dong['email'] ?>">
    </div>
  </div>
  <div class="form-group">
    <!-- <div class="col-sm-6">
      <a href="modules/giohang/indoadon.php"><button type="button" class="btn btn-secondary btn-lg btn-block" name="btninhoadon">In hoa don </button></a>
    </div> -->
    <div class="col-sm-12">
